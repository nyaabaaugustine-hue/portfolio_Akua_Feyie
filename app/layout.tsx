...
// Cloudinary logo — padded to 1200×630 OG format
const OG_IMAGE =
  'https://res.cloudinary.com/dwsl2ktt2/image/upload/w_1200,h_630,c_pad,b_rgb:1a1208/v1777771615/akuafeyielogo_ypjemo.jpg'

// Favicon variants from Cloudinary
const FAVICON_32 =
  'https://res.cloudinary.com/dwsl2ktt2/image/upload/w_32,h_32,c_fill,r_4/v1777771615/akuafeyielogo_ypjemo.jpg'
const FAVICON_180 =
  'https://res.cloudinary.com/dwsl2ktt2/image/upload/w_180,h_180,c_fill,r_8/v1777771615/akuafeyielogo_ypjemo.jpg'
...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: FAVICON_32,  sizes: '32x32',   type: 'image/jpeg' },
      { url: FAVICON_180, sizes: '180x180',  type: 'image/jpeg' },
    ],
    apple:    [{ url: FAVICON_180, sizes: '180x180', type: 'image/jpeg' }],
    shortcut: FAVICON_32,
  },
  ...
  openGraph: {
    ...
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: 'Akua Feyie – Entrepreneur · CEO · SMIC360', type: 'image/jpeg' }],
  },
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className={`${cormorant.variable} ${jost.variable} ${pinyon.variable} bg-cream text-dark antialiased`}>
        ...
        {/* z-[60] keeps it above mobile nav overlay (z-40) and other stacking contexts */}
        <a
          href="https://wa.me/233244783099"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Chat on WhatsApp"
          className="fixed bottom-5 right-4 sm:bottom-6 sm:right-6 z-[60] group"
          style={{ filter: 'drop-shadow(0 4px 16px rgba(37,211,102,0.35))' }}
        >
          {/* Button — slightly smaller on mobile so it doesn't crowd the screen */}
          <div
            className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-[#25D366] hover:bg-[#20c05c] transition-all duration-300 hover:scale-110"
            style={{ borderRadius: '14px' }}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-6 h-6 sm:w-7 sm:h-7" fill="white">
          ...
          {/* Tooltip — desktop only, hidden on mobile to avoid content overlap */}
          <span className="hidden sm:block absolute right-16 top-1/2 -translate-y-1/2 bg-dark text-cream text-xs font-body tracking-wide px-3 py-1.5 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none" style={{ borderRadius: '4px' }}>
            Chat on WhatsApp
          </span>
        </a>
      </body>
